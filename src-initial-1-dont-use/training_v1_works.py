...
def train_selfplay_boxing(n_episodes=1000, steps_per_episode=2000, 
    ...
    for episode in range(n_episodes):
        ...
        if (episode + 1) % 10 == 0:
            ...
            print(f"Episode {episode + 1}: Avg Reward={avg_reward:.2f}, Best={best_reward:.2f}")
...
if __name__ == "__main__":
    ...
    print("\nRequired packages:")
    print("pip install gymnasium[atari] ale-py torch numpy scipy")
    ...
    # Train
    agent, rewards = train_selfplay_boxing(
        n_episodes=50,
